...
export function createDefaultCreatureConfig(behavior: string = 'PlayerTree'): EntityConfig {
  ...
  return {
    ...
    movement: {
      ...
      standToCrouchTime: 0.1,
      crouchToStandTime: 0.1,
      standToProneTime: 0.5,
      proneToStandTime: 1.0,
      crouchToProneTime: 0.5,
      proneToCrouchTime: 1.0,
    },
    stealth: {
