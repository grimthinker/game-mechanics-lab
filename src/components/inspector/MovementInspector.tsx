  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
    ...
    <label>
      ...
      <input
        ...
        max={1080}
        step={10}
        onChange={(e) => onChange({ maxTurnSpeed: Number(e.target.value) as Degrees })}
      />
    </label>
    <label>
      ...
      <input
        ...
        max={10}
        step={0.1}
        onChange={(e) => onChange({ runSpeedMultiplier: Number(e.target.value) })}
      />
    </label>
    <label>
      ...
      <input
        ...
        max={10}
        step={0.1}
        onChange={(e) => onChange({ crouchSpeedMultiplier: Number(e.target.value) })}
      />
    </label>
    <label>
      ...
      <input
        ...
        max={10}
        step={0.1}
        onChange={(e) => onChange({ runTurnMultiplier: Number(e.target.value) })}
      />
    </label>
    <label>
      ...
      <input
        ...
        max={10}
        step={0.1}
        onChange={(e) => onChange({ crouchTurnMultiplier: Number(e.target.value) })}
      />
    </label>
  </div>
);