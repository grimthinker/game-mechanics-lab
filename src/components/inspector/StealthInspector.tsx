  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
    <label>
      ...
      <input
        ...
        max={1000}
        step={1}
        onChange={(e) => onChange({ stealthPower: Number(e.target.value) })}
      />
    </label>
    <label>
      ...
      <input
        ...
        max={10}
        step={0.1}
        onChange={(e) => onChange({ crouchStealthMultiplier: Number(e.target.value) })}
      />
    </label>
    <label>
      ...
      <input
        ...
        max={10}
        step={0.1}
        onChange={(e) => onChange({ runStealthMultiplier: Number(e.target.value) })}
      />
    </label>
  </div>
);